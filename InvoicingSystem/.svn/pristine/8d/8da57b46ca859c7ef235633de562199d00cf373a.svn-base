...
public class checksaleframe {
	JFrame checksaleframe=new JFrame("查看销售情况");
	checksalepanel mpanel;
	...
	public checksaleframe(String s,String iden){
		...
		checksaleframe.setIconImage(bg_icon);
		checksaleframe.setBounds((screenWidth-1000)/2, (screenHeight-600)/4, 1000, 600);
		mpanel=new checksalepanel();
		checksaleframe.setContentPane(mpanel);
		checksaleframe.add(a);
		mpanel.setVisible(true);
		checksaleframe.setVisible(true);
		checksaleframe.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		checksaleframe.repaint();
	}
	...
	public static void main(String args[]){
		checksaleframe f=new checksaleframe("liuzhijia","财务人员");
